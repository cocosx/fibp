...
\section{Technologies}
	It is very important to choose the right technology for the implementation of a project. I have devised the following criteria for the evaluation of available technologies.
	\begin{itemize}
		...
		\item \textbf{General suitability for the project}\\
			It must facilitate creation of a website. It is expected that there will be a lot of HTTP requests that will make only little chages to the database, e.g. marking of photos a user likes. There must be an easy way of making HTTP push communication to enable real-time chat. 
