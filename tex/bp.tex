...
\usepackage[scaled]{beramono} % Or some other package that provides a fixed width font. q.v.
                      % http://www.tug.dk/FontCatalogue/typewriterfonts.html
\usepackage{listings} 
%\lstset{                 % A rudimentary config that shows off some features.
%   basicstyle=\ttfamily\footnotesize % Without beramono, we'd get cmtt, the teletype font.
%}
