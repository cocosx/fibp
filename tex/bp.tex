...
%http://www.okcupid.com/about/technology
	...
	\begin{itemize}
		...
		\item \textbf{Performance}\\
			Again due to the low bugdet, the software must utilize the hardware as efficiently as possible. 
		\item \textbf{Stability and scalability}\\
			The user base could potentially grow very rapidly. It is therefore essential that all the system can match the growth cost efficiently. The framework should have a good track record of runtime stability.
	...
	\subsection{Performance}
	  ...
	  \centering
	    \includegraphics[width=0.7\textwidth]{bench2.png}
		  \caption{Language benchmark of V8 Engine, Python 3, Ruby 1.9 and PHP 5.4.0. Lower means faster.}
		  \label{fig:bench1}
		\end{figure}
	  ...
	  \centering
		...
		In conclusion, Node.js performs the best as both a language and a HTTP server framework. PHP and Sinatra split the second place.
		
	\subsection{Stability and scalability}
